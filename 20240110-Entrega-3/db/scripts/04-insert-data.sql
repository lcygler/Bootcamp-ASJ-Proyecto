...
INSERT INTO suppliers (code, business_name, industry_id, website, email, phone, image_id, address_id, tax_information_id, contact_detail_id) VALUES
('PROV-1', 'ElectroTech S.A.', 1, 'https://www.electrotech.com.ar', 'info@electrotech.com.ar', '+54 11 1234-5678',1 , 1, 1, 1),
('PROV-2', 'Ideal Hogar S.A.', 2, 'https://www.idealhogar.com.ar', 'contacto@idealhogar.com.ar', '+54 351 9876-5432', 2, 2, 2, 2),
('PROV-3', 'Wacker Herramientas S.R.L.', 3, 'https://www.wackerherramientas.com.ar', 'ventas@wacker.com.ar', '+54 341 5678-9012', 3, 3, 3, 3),
('PROV-4', 'ElectroHogar S.R.L.', 4, 'https://www.electrohogar.com.ar', 'info@electrohogar.com.ar', '+54 261 2345-6789', 4, 4, 4, 4),
('PROV-5', 'Distrito Moda S.A.', 5, 'https://www.distritomoda.com.ar', 'ventas@distritomoda.com.ar', '+54 381 8765-4321', 5, 5, 5, 5),
('PROV-6', 'Punto Deportivo S.A.', 6, 'https://www.puntodeportivo.com.ar', 'info@puntodeportivo.com.ar', '+54 387 5432-1098', 6, 6, 6, 6),
('PROV-7', 'Tienda Beauty S.A.', 7, 'https://www.tiendabeauty.com.ar', 'consultas@tiendabeauty.com.ar', '+54 299 1234-5678', 7, 7, 7, 7),
('PROV-8', 'El Mundo del Juguete S.R.L.', 8, 'https://www.elmundodeljuguete.com.ar', 'ventas@elmundodeljuguete.com.ar', '+54 280 9876-5432', 8, 8, 8, 8),
('PROV-9', 'Planeta Libros S.A.', 9, 'https://www.planetalibros.com.ar', 'info@planetalibros.com.ar', '+54 343 5678-9012', 9, 9, 9, 9),
('PROV-10', 'Café La Bastilla S.A.', 10, 'https://www.tiendacafelabastilla.com.ar', 'ventas@labastilla.com.ar', '+54 11 2345-6789', 10, 10, 10, 10);
...
INSERT INTO products (sku, name, description, price, image_id, category_id, supplier_id) VALUES
('SKU-1', 'Teléfono Inteligente', 'Teléfono inteligente de última generación', 159999.99, 11, 1, 1),
('SKU-2', 'Auriculares Inalámbricos', 'Auriculares con cancelación de ruido', 18999.99, 12, 1, 1),
('SKU-3', 'Sofá Moderno', 'Sofá elegante para tu hogar', 255999.99, 13, 2, 2),
('SKU-4', 'Mesa de Centro', 'Mesa de centro de diseño contemporáneo', 112999.99, 14, 2, 2),
('SKU-5', 'Taladro Eléctrico', 'Taladro potente para proyectos de bricolaje', 78999.99, 15, 3, 3),
('SKU-6', 'Juego de Destornilladores', 'Set completo de destornilladores profesionales', 20999.99, 16, 3, 3),
('SKU-7', 'Lavadora de Ropa', 'Lavadora eficiente con múltiples funciones', 588999.99, 17, 4, 4),
('SKU-8', 'Secadora de Ropa', 'Secadora de ropa con tecnología de secado rápido', 808999.99, 18, 4, 4),
('SKU-9', 'Vestido de Noche Elegante', 'Vestido largo para ocasiones especiales', 59900.00, 19, 5, 5),
('SKU-10', 'Zapatos de Tacón Alto', 'Zapatos elegantes para complementar tu look', 108499.99, 20, 5, 5),
('SKU-11', 'Pelota de Fútbol', 'Pelota oficial para partidos de fútbol', 19999.99, 21, 6, 6),
('SKU-12', 'Cinta de Correr Plegable', 'Cinta de correr para entrenamiento en casa', 314600.00, 22, 6, 6),
('SKU-13', 'Kit de Maquillaje Profesional', 'Colección completa de maquillaje de alta calidad', 36100.00, 23, 7, 7),
('SKU-14', 'Cepillo Alisador de Pelo', 'Cepillo que alisa el pelo de forma rápida y fácil', 34998.99, 24, 7, 7),
('SKU-15', 'Juguetes Educativos para Bebés', 'Set de juguetes didácticos para bebés', 2999.99, 25, 8, 8),
('SKU-16', 'Cuna Portátil', 'Cuna plegable y portátil para viajes', 227999.99, 26, 8, 8),
('SKU-17', 'Colección de Novelas Best Sellers', 'Paquete con las mejores novelas del año', 29999.99, 27, 9, 9),
('SKU-18', 'Libro de Cocina Gourmet', 'Libro con recetas gourmet y técnicas culinarias', 21870.00, 28, 9, 9),
('SKU-19', 'Máquina de Café Automática', 'Máquina de café con múltiples opciones de preparación', 196549.99, 29, 10, 10),
('SKU-20', 'Robot Aspirador Inteligente', 'Aspiradora robot con navegación inteligente', 314999.99, 30, 10, 10);
...
INSERT INTO orders (number, issue_date, delivery_date, comments, total, status_id, supplier_id, user_id) VALUES
('PO-1', '2023-06-01', '2023-06-10', 'Contactar con el encargado de logística.', 517999.95, 1, 1, 1),
('PO-2', '2023-06-15', '2023-06-25', 'Entregar en el almacén central.', 707999.95, 1, 2, 2),
('PO-3', '2023-07-05', '2023-07-15', 'Coordinar entrega con el departamento de compras.', 178999.97, 1, 3, 3),
('PO-4', '2023-08-01', '2023-08-11', 'Enviar a la sucursal de Mendoza.', 3384999.95, 2, 4, 4),
('PO-5', '2023-09-10', '2023-09-20', 'Prioridad en la entrega por necesidades urgentes.', 407999.99, 2, 5, 5),
('PO-6', '2023-10-01', '2023-10-11', 'Entregar antes de la fecha acordada.', 983799.98, 2, 6, 6),
('PO-7', '2023-11-05', '2023-11-15', 'Seguir protocolos de seguridad al entregar en planta.', 179398.99, 3, 7, 7),
('PO-8', '2023-12-01', '2023-12-11', 'Entrega rápida para eventos promocionales.', 464999.95, 3, 8, 8),
('PO-9', '2023-12-25', '2024-01-04', 'Coordinar entrega con el área de eventos.', 73739.99, 4, 9, 9),
('PO-10', '2024-01-01', '2024-01-10', 'Entregar productos antes del lanzamiento.', 1219649.95, 4, 10, 10);
