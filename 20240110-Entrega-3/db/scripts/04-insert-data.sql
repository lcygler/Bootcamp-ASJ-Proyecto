...
INSERT INTO vat_conditions (name) 
VALUES 
...
INSERT INTO tax_information (cuit, vat_condition_id) 
VALUES 
  ('45678901234', 1), 
  ('56789012345', 2), 
  ('67890123456', 1), 
...
VALUES 
  (
    ...
    'luis.fernandez@gmail.com', 'Gerente'
  ), 
  (
    'María', 'Martínez', '456789012', 
    'maria.martinez@gmail.com', 'Supervisor'
  ), 
  (
  ...
  (
    ...
    'laura.rodriguez@yahoo.com', 'Empleado'
  ), 
  (
    'Diego', 'Sánchez', '789012345', 
    'diego.sanchez@gmail.com', 'Empleado'
  ), 
  (
    'Ana', 'Fernández', '890123456', 
    'ana.fernandez@outlook.com', 'Gerente'
  ), 
  (
    'Sofía', 'García', '901234567', 
    'sofia.garcia@gmail.com', 'Asistente'
  ), 
  (
  ...
  (
    ...
    'marta.hernandez@gmail.com', 'Empleado'
  ), 
  (
...
INSERT INTO suppliers (
  ...
  tax_information_id, contact_detail_id
) 
VALUES 
  (
