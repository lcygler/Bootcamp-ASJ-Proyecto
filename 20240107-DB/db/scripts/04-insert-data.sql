...
('SKU-2', 'Silla Ergonómica Deluxe', 'Silla ergonómica con ajustes personalizados para mayor comodidad.', 299.99, 2, 2),
('SKU-3', 'Caja de Herramientas', 'Juego de herramientas completo para proyectos de construcción.', 129.99, 3, 3),
('SKU-4', 'Pack Superfood Orgánico', 'Paquete de superalimentos orgánicos para una alimentación saludable.', 49.99, 4, 4),
('SKU-5', 'Zapatillas ProFit Athletic', 'Zapatillas deportivas de alta calidad para entrenamientos intensivos.', 79.99, 5, 5),
('SKU-6', 'Kit de Laboratorio', 'Kit de laboratorio con productos químicos para experimentos científicos.', 89.99, 6, 6),
('SKU-7', 'Paneles Solares EcoPower', 'Paneles solares eficientes para generación de energía renovable.', 299.99, 7, 7),
('SKU-8', 'Chequeo de Salud WellCare', 'Paquete de servicios de chequeo de salud completo.', 149.99, 8, 8),
('SKU-9', 'Pizarra Interactiva EduTech', 'Pizarra interactiva para experiencias educativas innovadoras.', 499.99, 9, 9),
('SKU-10', 'Dispositivo Multifunción', 'Dispositivo multifunción para propósitos diversos.', 29.99, 10, 10),
('SKU-11', 'Smartwatch Z2', 'Reloj inteligente con funciones avanzadas de monitoreo.', 149.99, 1, 1),
('SKU-12', 'Escritorio de Oficina Pro', 'Escritorio de oficina con espacio amplio y diseño moderno.', 249.99, 2, 2),
('SKU-13', 'Taladro Eléctrico ProTool', 'Taladro eléctrico de alta potencia para proyectos de bricolaje.', 79.99, 3, 3),
('SKU-14', 'Set de Té Verde Orgánico', 'Set de té verde orgánico con variedad de sabores.', 19.99, 4, 4),
('SKU-15', 'Zapatillas Running Pro', 'Zapatillas para correr profesionales con tecnología de amortiguación.', 129.99, 5, 5),
('SKU-16', 'Kit Avanzado ScienceLab', 'Kit avanzado de laboratorio para experimentos científicos.', 159.99, 6, 6),
('SKU-17', 'Cargador Portátil SolarCharge', 'Cargador portátil con energía solar para dispositivos móviles.', 49.99, 7, 7),
('SKU-18', 'Paquete de Chequeo de Bienestar', 'Paquete integral de servicios de bienestar y chequeo de salud.', 299.99, 8, 8),
('SKU-19', 'Tablet Educativa EduTech', 'Tablet educativa para el aprendizaje interactivo.', 199.99, 9, 9),
('SKU-20', 'Dispositivo Multifuncional X', 'Dispositivo multifuncional con características avanzadas.', 39.99, 10, 10);
