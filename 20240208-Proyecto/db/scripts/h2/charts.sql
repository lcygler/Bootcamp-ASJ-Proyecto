...
-- Top Suppliers
SELECT s.business_name, COUNT(o.supplier_id) AS "order_count"
FROM orders o
...
-- Months Total
SELECT EXTRACT(YEAR FROM issue_date) AS "year", EXTRACT(MONTH FROM issue_date) AS "month", SUM(total) AS "total"
FROM orders
