...
public class ImageController {
	...
	@PostMapping
	public ResponseEntity<?> createImage(@Valid @RequestBody ImageModel image, BindingResult bindingResult) {
		try {
	...
	@PutMapping("/{id}")
	public ResponseEntity<?> updateImage(@PathVariable Integer id, @Valid @RequestBody ImageModel image,
