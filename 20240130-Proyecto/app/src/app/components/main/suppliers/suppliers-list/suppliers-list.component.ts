...
export class SuppliersListComponent implements OnInit {
  ...
  updateSupplierFilter() {
    switch (this.supplierFilter) {
      case 0:
        this.supplierFilter = 1; // Ascending
        break;
      case 1:
        this.supplierFilter = 2; // Descending
        break;
      default:
        this.supplierFilter = 0; // Default
        break;
    }
  }
  ...
  updateLocationFilter() {
    switch (this.locationFilter) {
      case 0:
        this.locationFilter = 1; // Ascending
        break;
      case 1:
        this.locationFilter = 2; // Descending
        break;
      default:
        this.locationFilter = 0; // Default
        break;
    }
  }
}
