...
public class UserCredentialController {
	...
	@PostMapping
	public ResponseEntity<Object> createUserCredential(@Valid @RequestBody UserCredentialModel userCredential,
	...
	@PutMapping("/{id}")
	public ResponseEntity<Object> updateUserCredential(@PathVariable Integer id,
	...
	@PatchMapping("/{id}")
	public ResponseEntity<Object> patchUserCredential(@PathVariable Integer id,
