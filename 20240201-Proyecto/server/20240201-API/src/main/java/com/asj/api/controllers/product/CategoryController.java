...
public class CategoryController {
	...
	@PostMapping
	public ResponseEntity<Object> createCategory(@Valid @RequestBody CategoryModel category,
	...
	@PutMapping("/{id}")
	public ResponseEntity<Object> updateCategory(@PathVariable Integer id, @Valid @RequestBody CategoryModel category,
			BindingResult bindingResult) {
		try {
			if (bindingResult.hasErrors()) {
				Map<String, String> errors = ValidationUtils.handleErrors(bindingResult);
	...
	@PatchMapping("/{id}")
	public ResponseEntity<Object> patchCategory(@PathVariable Integer id, @RequestBody CategoryModel category) {
		try {
