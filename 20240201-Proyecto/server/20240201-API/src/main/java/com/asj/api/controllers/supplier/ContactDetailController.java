...
public class ContactDetailController {
	...
	@PostMapping
	public ResponseEntity<Object> createContactDetail(@Valid @RequestBody ContactDetailModel contactDetail,
	...
	@PutMapping("/{id}")
	public ResponseEntity<Object> updateContactDetail(@PathVariable Integer id,
	...
	@DeleteMapping("/{id}")
	public ResponseEntity<Object> deleteContactDetail(@PathVariable Integer id) {
		try {
