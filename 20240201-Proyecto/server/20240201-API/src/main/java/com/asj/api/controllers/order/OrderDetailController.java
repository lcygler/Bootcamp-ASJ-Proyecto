...
public class OrderDetailController {
	...
	@PostMapping
	public ResponseEntity<Object> createOrderDetail(@Valid @RequestBody OrderDetailModel orderDetail,
	...
	public ResponseEntity<Object> createOrderDetails(@Valid @RequestBody List<OrderDetailModel> orderDetails,
			BindingResult bindingResult) {
		try {
			if (bindingResult.hasErrors()) {
				Map<String, String> errors = ValidationUtils.handleErrors(bindingResult);
	...
	@PatchMapping("/{id}")
	public ResponseEntity<Object> patchOrderDetail(@PathVariable Integer id,
