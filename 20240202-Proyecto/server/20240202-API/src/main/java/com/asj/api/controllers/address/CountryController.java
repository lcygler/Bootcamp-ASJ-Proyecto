...
public class CountryController {
	...
	@PutMapping("/{id}")
	public ResponseEntity<Object> updateCountry(@PathVariable Integer id, @Valid @RequestBody CountryModel country,
	...
	@PatchMapping("/{id}")
	public ResponseEntity<Object> patchCountry(@PathVariable Integer id, @RequestBody CountryModel country) {
		try {
