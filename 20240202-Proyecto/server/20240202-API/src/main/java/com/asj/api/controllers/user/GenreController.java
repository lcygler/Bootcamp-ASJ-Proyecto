...
public class GenreController {
	...
	@PostMapping
	public ResponseEntity<Object> createGenre(@Valid @RequestBody GenreModel genre, BindingResult bindingResult) {
		try {
	...
	@PutMapping("/{id}")
	public ResponseEntity<Object> updateGenre(@PathVariable Integer id, @Valid @RequestBody GenreModel genre,
	...
	@PatchMapping("/{id}")
	public ResponseEntity<Object> patchGenre(@PathVariable Integer id, @RequestBody GenreModel genre) {
		try {
