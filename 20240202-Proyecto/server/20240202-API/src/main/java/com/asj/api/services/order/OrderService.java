...
public class OrderService {
	...
	public String generateOrderNumber(LocalDateTime issueDate) {
		int orderCountForDay = orderRepository.countByIssueDate(issueDate);
		String yearMonthDay = issueDate.format(DateTimeFormatter.BASIC_ISO_DATE);
		String orderNumber = "OC-" + yearMonthDay + "-" + (orderCountForDay + 1);
