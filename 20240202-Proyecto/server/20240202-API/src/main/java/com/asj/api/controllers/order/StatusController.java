...
public class StatusController {
	...
	@PutMapping("/{id}")
	public ResponseEntity<Object> updateStatus(@PathVariable Integer id, @Valid @RequestBody StatusModel status,
	...
	@PatchMapping("/{id}")
	public ResponseEntity<Object> patchStatus(@PathVariable Integer id, @RequestBody StatusModel status) {
		try {
